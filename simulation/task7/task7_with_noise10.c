...
double NOISE_POWER = 0.1; //noise power relative to signal power
...
int main(void) {
    ...
    FILE *transmittedSymbolOutput = fopen("data/task7/transmitted_signal_output_noise10.dat", "w");
    FILE *receivedSignalOutput = fopen("data/task7/received_signal_output_noise10.dat", "w");
    FILE *filteredSignalOutput = fopen("data/task7/filtered_signal_output_noise10.dat", "w");
