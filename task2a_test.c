...
int main(){
    int num_rand = 10000000; //define number of pseudo-random numbers to generate
    double number; //create variable to store a random number
    FILE *file = fopen("task2a.dat", "w"); //create output file to which random numbers are written
