...
grid on;
xlabel('Frequency');
ylabel('Transmitted Signal Power [dBW]');

subplot(5,2,4);
plot(fx,power_x)
grid on;
xlabel('Frequency');
ylabel('Pre-LPF Received Signal Power [dBW]');

subplot(5,2,6);
plot(fy,power_y);
grid on;
xlabel('Frequency');
ylabel('Post-LPF Received Signal Power [dBW]');

subplot(5,2,8);
plot(fa,power_a);
grid on;
xlabel('Frequency');
ylabel('Received Symbol Averaged Signal [dBW]');

subplot(5,2,10);
plot(fd,power_d);
grid on;
xlabel('Frequency');
ylabel('Received Digital Signal Power [dBW]');